...
parser = argparse.ArgumentParser(description='finding VEFS-Box containing proteins')
...
os.system('hmmsearch --tblout %s --noali --cpu %s %s %s'%(dom_out,threads,os.path.join(db_path, 'PF09733.hmm'),dom_in))
